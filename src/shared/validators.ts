/**
 * Bridge Validators - Single Source of Truth
 *
 * Contains: Convex validators, inferred types, runtime enums, branded IDs, and entity interfaces.
 */
...
export const variantValidator = literals(
  'STRING',
  'TEXT',
  'NUMBER',
  'BOOLEAN',
...
export type VariantValue = Infer<typeof variantValidator>;

export const securityValidator = literals('PUBLIC', 'CONFIDENTIAL', 'RESTRICTED');
export type SecurityValue = Infer<typeof securityValidator>;

export const sourceValidator = literals('form', 'import', 'api');
export type SourceValue = Infer<typeof sourceValidator>;
...
/**
 * Card document validator.
 * Note: Convex adds _id and _creationTime at runtime, but we don't expose them in the API.
 */
...
/**
 * Deliverable document validator.
 */
...
// Core entities - inferred directly from Doc validators
